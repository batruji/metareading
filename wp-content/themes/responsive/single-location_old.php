...
/**
 * Single Locations Template
 *
Template Name:   Single Locations
 *
 * @file           single-location.php
 * @package        Responsive 
 * @author         Ivan Chomakov 
 * @copyright      2003 - 2012 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/single-location.php
 * @link           http://codex.wordpress.org/Post_Types#Template_Files
