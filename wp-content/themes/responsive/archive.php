...
<div id="the_mentor_page" class="container">
	...
	<div class="container page_container">
		<div class="page_content col-xs-12 col-md-12 col-sm-12">
			<div class="posts_content col-xs-12 col-md-9 col-sm-8">        
...
<?php if (have_posts()) : ?>
        ...
        <?php endif; ?>
		    ...
		    <h6 class="special">				
			    <?php if ( is_day() ) : ?>
				<span class="daily_arch">
				    <?php printf( __( 'Daily Archives: %s', 'responsive' ),  get_the_date() ); ?>
				</span>
				<?php elseif ( is_month() ) : ?>
				<span class="month_arch">
					<?php printf( __( 'Monthly Archives: %s', 'responsive' ),  get_the_date( 'F Y' )   ); ?>
				</span>
				<?php elseif ( is_year() ) : ?>
				<span class="yearly_arch">
					<?php printf( __( 'Yearly Archives: %s', 'responsive' ),  get_the_date( 'Y' ) ); ?>
				</span>
				<?php else : ?>
				<span class="blog_arch">
